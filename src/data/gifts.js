...
export const GIFTS = [
  ...
  { id: "c12", img: "/gifts/c12.webp", cat: { fr: "Cuisine", icon: "🍳" }, catEn: "Kitchen", name: { fr: "Coravin", en: "Coravin" }, amount: 300, stripe: "" },
  { id: "c13", img: "/gifts/c13.webp", cat: { fr: "Cuisine", icon: "🍳" }, catEn: "Kitchen", name: { fr: "Cocotte", en: "Dutch oven" }, amount: 200, stripe: "" },
  ...
  { id: "m8",  img: "/gifts/m8.webp",  cat: { fr: "Maison", icon: "🏡" }, catEn: "Home", name: { fr: "Grande Bougie", en: "Large candle" }, amount: 120, stripe: "" },
  ...
  { id: "sp1", img: "/gifts/sp1.webp", cat: { fr: "Sports & Voyages", icon: "⛷️" }, catEn: "Sports & Travel", name: { fr: "Chaussures de ski pour Louis", en: "Ski boots for Louis" }, amount: 300, stripe: "" },
  { id: "sp2", img: "/gifts/sp2.webp", cat: { fr: "Sports & Voyages", icon: "⛷️" }, catEn: "Sports & Travel", name: { fr: "Chaussures de ski pour Oriane", en: "Ski boots for Oriane" }, amount: 250, stripe: "" },
  { id: "sp3", img: "/gifts/sp3.webp", cat: { fr: "Sports & Voyages", icon: "⛷️" }, catEn: "Sports & Travel", name: { fr: "Tente Trek", en: "Trekking tent" }, amount: 500, stripe: "" },
  { id: "sp4", img: "/gifts/sp4.webp", cat: { fr: "Sports & Voyages", icon: "⛷️" }, catEn: "Sports & Travel", name: { fr: "Valise Cabine", en: "Cabin suitcase" }, amount: 200, stripe: "" },
